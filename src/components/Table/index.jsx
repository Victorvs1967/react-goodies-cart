...
const Table = () => {
  ...
  const [ table, setTable ] = useState(goodies.map(goodie => 
      ({ 
        ...goodie, 
  ...
  const incrise = id => setTable(table => table.map(goodie => 
    goodie.id === id ? 
    { ...goodie,
      count: ++goodie.count, 
      priceTotal: goodie.price * goodie.count,
  ...
  const decrise = id => setTable(table => table.map(goodie => 
    goodie.id === id ? 
    { ...goodie,
  ...
  const deleteGoogie = id => setTable(table => table.filter(goodie => id !== goodie.id));
